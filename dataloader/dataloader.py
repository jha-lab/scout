...
class PreTrainDataLoader:
	...
	def __init__(self, seed, dir_path, device, config, target_id, topk = None,weights=None, lowrank_approx = False, rank =55):
		...
		if lowrank_approx:	
			red_data[:,:,:self.cont_dim] = low_rank(red_data[:,:,:self.cont_dim],rank)
...
class FinetuneDataLoader(object):
	...
	def __init__(self, seed, dir_path, device, config, target_id, interv_time, topk=None,weights=None, lowrank_approx = False, rank = 55):
